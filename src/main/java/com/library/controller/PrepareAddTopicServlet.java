...
/**
 * Servlet implementation class PrepareAddTopicServlet
 */
@WebServlet("/prepareAddTopic")
public class PrepareAddTopicServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrepareAddTopicServlet() {
        super();
